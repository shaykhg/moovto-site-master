...
@Component({
  selector: 'app-moving-delivery',
  templateUrl: './moving-delivery.component.html',
  styleUrls: ['./moving-delivery.component.scss']
})
export class MovingDeliveryComponent implements OnInit {
  images: boolean[] = [];
